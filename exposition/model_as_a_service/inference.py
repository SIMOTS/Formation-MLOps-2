...
def predict_endpoint():
    ...
    df_prepared = prepare_features(received_data_df,training_mode=False)
    prediction = predict(df_prepared, MODEL_PATH)['predictions'].to_dict()
