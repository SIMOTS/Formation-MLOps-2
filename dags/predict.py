...
from dags.config import GENERATED_DATA_PATH, DATA_FOLDER, MODEL_PATH, PREDICTIONS_FOLDER, GENERATED_DATA_FOLDER
...
def predict():
    ...
    def predict_with_io_task(feature_path):
        predict_with_io(feature_path, model_path=MODEL_PATH, predictions_folder=PREDICTIONS_FOLDER)
        
    # End completing predict task

    features_path = prepare_features_with_io_task()
    predict_with_io_task(feature_path=features_path)
